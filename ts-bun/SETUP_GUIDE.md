...
## 📁 Directory Structure for ts-bun/
...
```
🚀 Starting Benchmark (Bun Runtime)
==================================================
...
```
Command being timed: "bun run main.ts example"
...
1. **Test Bun Implementation**: `cd ts-bun && ./run.sh`
